...
def evaluate_model(x_train, y_train, x_test, y_test):
    ...
    # save model
    model.save('MNIST_classification_model_noise_75.h5')

    return history, history.history['val_accuracy']


# Question no 02 [CNN models with noise factor]
# ---------------------------------------------------------------------------------------------------------------------
# load data
...
# modelling
history, accuracy_over_epoch = evaluate_model(x_train_noisy, y_train, x_test_noisy, y_test)
accuracy_over_epoch = pd.DataFrame(accuracy_over_epoch)
# accuracy_over_epoch.to_csv("E:/MSc/Sem 02/Machine Learning/Assignment 02/SGD_accuracies_over_epoch_more_layers_with_noise_0_75.csv")
